...
def SVMModelDense(pca_train, train_y, pca_test, test_y, lamb, zoom, le_classes_):
    '''
...
if __name__ == '__main__':
    ...
    train_count, test_count, sample_count = SparseMatrix(train, test, sample)
    test_count.shape, sample_count.shape
    SVMModelDense(train_count, train.y.values, test_count, test.y.values, 10, 10, cat)
